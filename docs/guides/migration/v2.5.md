...
👉 New `styles` service, `KStyleEditor`, `KLayerStyleAction` and `KStyleManager` components to be used in your application in order to manage layer styles, [Kano](https://kalisio.github.io/kano/) includes an example.
