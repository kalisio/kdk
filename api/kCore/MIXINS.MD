...
A Kaelia map is based on a [Leaflet](http://leafletjs.com/) map object.
...
A Kaelia map relies on a configuration object detailing mixins to be used with their options like this:
```javascript
module.exports = {
  ...
map: {
